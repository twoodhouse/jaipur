...
class RandomStrategy2():
    ...
    def takeCardChoice(self, gameView):
        ...
        if Resource.Gem in options:
            return Resource.Gem
        if Resource.Gold in options:
            return Resource.Gold
        if Resource.Silver in options:
